  ...
  <div class="container px-5 py-12 mx-auto">
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
        ...
        <div class="p-2 flex justify-around w-full">
          <button onclick="location.href='{{ route('admin.owners.index')}}'" class=" text-white bg-gray-300 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg">戻る</button>
